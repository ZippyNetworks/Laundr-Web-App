      ...
      case 4:
        ...
        if (!orderPlaced) {
          this.setState({
            error: true,
            errorMessage:
              "There was an error with placing your order. Please try again later. If this problem continues, contact us.  Error code: 3",
          });
          canNext = false;
        }
        break;
...
class NewOrderOld extends Component {
  constructor(props) {
    super(props);
