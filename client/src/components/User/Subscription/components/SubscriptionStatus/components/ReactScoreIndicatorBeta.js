...
var Score = (function (_React$Component) {
  ...
  function Score() {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Score.__proto__ || Object.getPrototypeOf(Score)).call(this)
    );
      ...
      (_ret =
        ((_temp =
          ((_this = possibleConstructorReturn(
            this,
            (_ref =
              Score$$1.__proto__ || Object.getPrototypeOf(Score$$1)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
          _this)),
        (_this.getCurrentColor = function (num) {
          var stepsColors = _this.props.stepsColors;

          if (num <= 0) return stepsColors[0];
          if (num > stepsColors.length)
  ...
  createClass(Score$$1, [
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            Score,
            _extends({ scoreNumber: Number(numberHighlight) }, this.props)
          ),
...
function ReactScoreIndicator(props) {
  ...
  return React.createElement(
    "div",
    {
      ...
      style: _extends({ width: width + "px" }, style),
    },
